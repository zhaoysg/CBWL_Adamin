...
def validate_production_settings() -> None:
    ...
    if settings.ACCESS_TOKEN_EXPIRE_SECONDS <= 0 or settings.ACCESS_TOKEN_EXPIRE_SECONDS > 30 * 60:
        errors.append("生产 Access Token 有效期必须在 1 至 1800 秒之间")
    if settings.REFRESH_TOKEN_EXPIRE_SECONDS <= settings.ACCESS_TOKEN_EXPIRE_SECONDS:

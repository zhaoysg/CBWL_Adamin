...
from sqlalchemy import CheckConstraint, Index, Integer, JSON, Numeric, String, Text, UniqueConstraint
...
class MemberPlanModel(ModelMixin, UserMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint("rank >= 1 AND rank <= 100", name="ck_cw_member_plan_rank"),
    ...
    rank: Mapped[int] = mapped_column(Integer, nullable=False, default=1, comment="权益等级")
